...
class RNNAE(nn.Module):
    ...
    def __init__(self):
        ...
        # encoder
        self.hidden_size_enc = 4
        self.input_size_enc = 8
        self.output_size_enc = 2
...
LR_STEP_SIZE = 2000
LR_GAMMA = 0.1
DATANAME = "models/dataset.pkl"
SAVENAME = "models/lstm.pt"


def main():

    data = torch.tensor(pickle.load(open(DATANAME, "rb")))
    model = RNNAE()
